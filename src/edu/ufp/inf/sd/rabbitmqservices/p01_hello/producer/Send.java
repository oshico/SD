package edu.ufp.inf.sd.rabbitmqservices.p01_hello.producer;
...
public class Send {
     ...
     * $ ./runconsumer hello world again (must concatenate msg "hello world again" to send)
     *
     * @param args
     */
