...
public class ObserverGuiClient extends javax.swing.JFrame {
    ...
    public ObserverGuiClient(String args[]) {
        try {
            ...
            //2. Create the observer object that manages send/receive of messages to/from rabbitmq
    ...
    /**
     * Notify/update the GUI, whenever a new msg is received/consumed from the broker.
     */
    ...
    /**
     * Send msg through the observer to the exchange where all observers are bound.
     *
     * @param msgToSend
     */
