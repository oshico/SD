...
export JDK=/usr/lib/jvm/java-1.17.0-openjdk-amd64  # Example for OpenJDK 11
...
export PACKAGE=p04_diglib
export PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
export PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
export SERVICE_NAME_ON_REGISTRY=DigLibService
export CLIENT_CLASS_PREFIX=DigLib
export SERVER_CLASS_PREFIX=DigLibFactory
