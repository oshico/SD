package edu.ufp.inf.sd.rmi.p02_calculator.client;

import edu.ufp.inf.sd.rmi.p02_calculator.server.CalculatorRI;
...
public class CalculatorClient {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 2) {
            System.err.println("usage: java [options] edu.ufp.sd.inf.rmi.p02_calculator.server.HelloWorldClient <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
